...
from stillsupport.extensions.views.ticket import Ticket
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if not tview.timed_out and not tview.repeat:
            ...
            try:
                ...
                embed = discord.Embed(
                    title="Open Tickets",
                    description="No open tickets. Nice work!",
...
class Queue(discord.ui.View):
    ...
    async def build_embed(self):
        ...
        for ticket in self.tickets[self.page]:
            ...
            self.embed.description += f"**{counter}.** Opened by: {user}; {timestamp}\n"
            counter += 1
    ...
    async def on_timeout(self):
        if not self.processing:
            await self.original.edit(content="Timed out. Restart process and try again.", view=None)