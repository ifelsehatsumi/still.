"""AutoRoom cog for Red-DiscordBot by NylaPop."""
import asyncio
                ...
                for member in source_channel.members:
                    ...
                    if "text_channel" in avc_settings and avc_settings["text_channel"]:
                        ...
                        await new_text_channel.send(
                            f"{member.mention}, "
                            "this is your own text channel that anyone in your private room can use. No one can see it but you and your roommates. I'll give each person access as they join your room. When everyone leaves your room, this channel will be deleted."
                        )
